...
- Avulsos de **R$ 9 a R$ 49** (somam R$ 8.105); coleções de **R$ 36 a R$ 588**
- Vitrine cheia: **R$ 17.648**
...
os boxes de universo, **18%**.

---

## Capas

Cascata que nunca deixa espaço vazio: URL do cadastro → cache do navegador →
Google Books → Open Library → capa desenhada em SVG na hora. Para fixar uma capa,
preencha o campo `img`.
