...
Hoje: **351 com URL fixa**, **62 com montagem dos volumes** e **22 com capa
desenhada**. Ou seja, 413 dos 435 anúncios mostram uma capa real.

As URLs fixas vêm dos sites das próprias editoras brasileiras, onde a edição é a
certa por definição: Amazon (187), Shopify das editoras Record/HarperCollins/Aleph
(52), Intrínseca (45), Companhia das Letras (23) e Rocco (22).
...
Dezesseis anúncios estão marcados com `revisar: 1` e aparecem na aba *Conferir
...
Faltam 22 anúncios sem capa, somando R$ 505 da vitrine: 6 Agatha Christie e 5 Star
Wars fora do catálogo das editoras, 3 da *Doutrina da Morte*, 5 avulsos sem saga e
3 soltos. Todos estão na aba *Sem capa* da página.
